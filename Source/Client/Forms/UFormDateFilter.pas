...
uses
  ...
  cxLookAndFeels, cxLookAndFeelPainters,UMgrLang;
...
begin
  gMultiLangManager.SectionID := TfFormDateFilter.ClassName;
...
begin
  ...
  begin
    EditEnd.SetFocus;
    nLang := MLang('结束日期不能小于开始日期');
    nHint := MLang(sHint);
    ShowMsg(nLang, nHint);
  end else ModalResult := mrOK;
end;

procedure TfFormDateFilter.FormCreate(Sender: TObject);
begin
    gMultiLangManager.SectionID := 'TfFormDateFilter';
