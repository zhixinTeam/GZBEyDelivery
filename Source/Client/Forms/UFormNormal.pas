...
uses
  ...
  StdCtrls, cxControls, cxGraphics, cxLookAndFeels, cxLookAndFeelPainters,UMgrLang;
...
begin
  gMultiLangManager.SectionID := TfFormNormal.ClassName;
