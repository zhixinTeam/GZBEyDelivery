...
uses
  ...
  cxEdit, cxTextEdit, cxMCListBox, Menus, UFormBase, cxGraphics,
...
{$R *.dfm}
uses
  IniFiles, ULibFun, UMgrControl, UFormConn, UFormWait, USysDB, USysConst,UMgrLang;

function MLang(const nStr: string): string;
begin
  gMultiLangManager.SectionID := TfFormRestoreSQL.ClassName;
