...
{$R *.dfm}
uses
  ULibFun, UMgrControl, UFormBase, UFormCtrl, USysConst, USysDB, UDataModule, UMgrLang;

function MLang(const nStr: string): string;
begin
  gMultiLangManager.SectionID := TfFrameAuthorize.ClassName;
