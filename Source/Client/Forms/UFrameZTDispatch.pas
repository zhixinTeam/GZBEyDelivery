...
uses
  ...
  USysDB, USysConst, USysFun, USysPopedom, UDataModule, USysLoger,UMgrLang;

function MLang(const nStr: string): string;
begin
  gMultiLangManager.SectionID := TfFrameZTDispatch.ClassName;
...
begin
  ...
  ShowMsg( MLang('请不要频繁刷新'), MLang(sHint));
end;
