...
uses
  ...
  UFormCtrl, USysDB, USysConst ,USysLoger,UMgrLang;
...
begin
  gMultiLangManager.SectionID := TfFormZTLine.ClassName;
...
begin
  ...
  //--写入操作通道日志
  ShowMsg(MLang('通道已保存,请等待刷新'), MLang(sHint));
end;
