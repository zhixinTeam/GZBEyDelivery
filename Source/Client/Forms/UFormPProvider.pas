...
begin
  gMultiLangManager.SectionID := TfFormProvider.ClassName;
...
begin
  ...
  begin
    nLnag := MLang('请选择要删除的内容');
    nHint := MLang(sHint);
    ShowMsg(nLnag, nHint); Exit;
  end;
...
var nList: TStrings;
    nStr,nID,nTmp,nSQL,nLang,nHint: string;
